...
static void i420_to_i420( p264_frame_t *frm, p264_image_t *img,
                          int i_width, int i_height )
{
    if( img->i_csp & P264_CSP_VFLIP )
    {
...
static void yv12_to_i420( p264_frame_t *frm, p264_image_t *img,
                          int i_width, int i_height )
{
    if( img->i_csp & P264_CSP_VFLIP )
    {
...
static void i422_to_i420( p264_frame_t *frm, p264_image_t *img,
                          int i_width, int i_height )
{
    if( img->i_csp & P264_CSP_VFLIP )
    {
...
static void i444_to_i420( p264_frame_t *frm, p264_image_t *img,
                          int i_width, int i_height )
{
    if( img->i_csp & P264_CSP_VFLIP )
    {
...
static void yuyv_to_i420( p264_frame_t *frm, p264_image_t *img,
                          int i_width, int i_height )
{
...
static void name( p264_frame_t *frm, p264_image_t *img, \
                  int i_width, int i_height )           \
{                                                       \
    uint8_t *src = img->plane[0];                       \
    int     i_src= img->i_stride[0];                    \
...
void p264_csp_init( int cpu, int i_csp, p264_csp_function_t *pf )
{
    switch( i_csp )
    {
        ...
        default:
            ...
            fprintf( stderr, "arg in p264_csp_init\n" );
            exit( -1 );
            break;
    }
}
