...
SECTION .text
cglobal p264_deblock_v8_luma_mmxext
cglobal p264_deblock_h_luma_mmxext
cglobal p264_deblock_v_chroma_mmxext
cglobal p264_deblock_h_chroma_mmxext
cglobal p264_deblock_v_chroma_intra_mmxext
cglobal p264_deblock_h_chroma_intra_mmxext
...
%define pix_tmp esp
    ...
    call   p264_deblock_v8_luma_mmxext
...
;-----------------------------------------------------------------------------
p264_deblock_v_chroma_intra_mmxext:
    CHROMA_V_START
    movq  mm0, [eax]
    movq  mm1, [eax+esi]
    movq  mm2, [edi]
...
;-----------------------------------------------------------------------------
p264_deblock_h_chroma_intra_mmxext:
    CHROMA_H_START
    TRANSPOSE4x8_LOAD  PASS8ROWS(eax, edi, esi, ebp)
    CHROMA_INTRA_BODY
    TRANSPOSE8x4_STORE PASS8ROWS(eax, edi, esi, ebp)
