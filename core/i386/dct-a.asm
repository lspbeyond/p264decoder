...
ALIGN 16
p264_mmx_1:        dw  1,  1,  1,  1
p264_mmx_32:       dw 32, 32, 32, 32
p264_mmx_PPNN:     dw  1,  1, -1, -1
p264_mmx_PNPN:     dw  1, -1,  1, -1 
p264_mmx_PNNP:     dw  1, -1, -1,  1 
p264_mmx_PPPN:     dw  1,  1,  1, -1 
p264_mmx_PPNP:     dw  1,  1, -1,  1 
p264_mmx_2121:     dw  2,  1,  2,  1 
p264_mmx_p2n2p1p1: dw  2, -2,  1,  1
...
cglobal p264_dct4x4dc_mmxext

ALIGN 16
;-----------------------------------------------------------------------------
;   void __cdecl dct4x4dc( int16_t d[4][4] )
;-----------------------------------------------------------------------------
p264_dct4x4dc_mmxext:
    mov     eax,        [esp+ 4]
    movq    mm0,        [eax+ 0]
    movq    mm1,        [eax+ 8]
    movq    mm2,        [eax+16]
...
cglobal p264_idct4x4dc_mmxext

ALIGN 16
;-----------------------------------------------------------------------------
;   void __cdecl p264_idct4x4dc_mmxext( int16_t d[4][4] )
;-----------------------------------------------------------------------------
p264_idct4x4dc_mmxext:
    mov     eax, [esp+ 4]
    movq    mm0, [eax+ 0]
    movq    mm1, [eax+ 8]
    movq    mm2, [eax+16]
...
cglobal p264_sub4x4_dct_mmxext

ALIGN 16
;-----------------------------------------------------------------------------
;   void __cdecl p264_sub4x4_dct_mmxext( int16_t dct[4][4], uint8_t *pix1, int i_pix1, uint8_t *pix2, int i_pix2 )
;-----------------------------------------------------------------------------
p264_sub4x4_dct_mmxext:
    push    ebx
    mov     eax, [esp+12]   ; pix1
...
cglobal p264_add4x4_idct_mmxext

ALIGN 16
;-----------------------------------------------------------------------------
;   void __cdecl p264_add4x4_idct_mmxext( uint8_t *p_dst, int i_dst, int16_t dct[4][4] )
;-----------------------------------------------------------------------------
p264_add4x4_idct_mmxext:
...
cglobal p264_pixel_sub_8x8_mmx
cglobal p264_xdct8_mmxext
cglobal p264_ydct8_mmx

cglobal p264_xidct8_mmxext
cglobal p264_yidct8_mmx
cglobal p264_pixel_add_8x8_mmx

ALIGN 16
;-----------------------------------------------------------------------------
;   void __cdecl p264_pixel_sub_8x8_mmx( int16_t *diff, uint8_t *pix1, int i_pix1, uint8_t *pix2, int i_pix2 );
;-----------------------------------------------------------------------------
p264_pixel_sub_8x8_mmx:
...
ALIGN 16
;-----------------------------------------------------------------------------
;   void __cdecl p264_xdct8_mmxext( int16_t dest[8][8] );
;-----------------------------------------------------------------------------
p264_xdct8_mmxext:

    mov         eax, [esp+04]           ; dest
    movq        mm5, [p264_mmx_PPNN]
    movq        mm6, [p264_mmx_PNNP]
    movq        mm4, [p264_mmx_PPPN]
    movq        mm7, [p264_mmx_PPNP]
...
ALIGN 16
;-----------------------------------------------------------------------------
;   void __cdecl p264_ydct8_mmx( int16_t dest[8][8] );
;-----------------------------------------------------------------------------
p264_ydct8_mmx:
...
ALIGN 16
;-----------------------------------------------------------------------------
;   void __cdecl p264_xidct8_mmxext( int16_t dest[8][8] );
;-----------------------------------------------------------------------------
p264_xidct8_mmxext:

    mov         eax, [esp+04]           ; dest
    movq        mm4, [p264_mmx_PPNN]
    movq        mm5, [p264_mmx_PNPN]
    movq        mm6, [p264_mmx_PPNP]
    movq        mm7, [p264_mmx_PPPN]
    ...
    pmullw      mm0, [p264_mmx_p2n2p1p1]; (low)2*d0,-2*d4,d2,d6(high)
...
ALIGN 16
;-----------------------------------------------------------------------------
;   void __cdecl p264_yidct8_mmx( int16_t dest[8][8] );
;-----------------------------------------------------------------------------
p264_yidct8_mmx:
...
ALIGN 16
;-----------------------------------------------------------------------------
;   void __cdecl p264_pixel_add_8x8_mmx( unit8_t *dst, int i_dst, int16_t src[8][8] );
;-----------------------------------------------------------------------------
p264_pixel_add_8x8_mmx:
    mov         eax, [esp+04]       ; dst
