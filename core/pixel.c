...
void p264_pixel_init( int cpu, p264_pixel_function_t *pixf )
{
    ...
    {
        pixf->sad[PIXEL_16x16] = p264_pixel_sad_16x16_mmxext;
        pixf->sad[PIXEL_16x8 ] = p264_pixel_sad_16x8_mmxext;
        pixf->sad[PIXEL_8x16 ] = p264_pixel_sad_8x16_mmxext;
        pixf->sad[PIXEL_8x8  ] = p264_pixel_sad_8x8_mmxext;
        pixf->sad[PIXEL_8x4  ] = p264_pixel_sad_8x4_mmxext;
        pixf->sad[PIXEL_4x8  ] = p264_pixel_sad_4x8_mmxext;
        pixf->sad[PIXEL_4x4]   = p264_pixel_sad_4x4_mmxext;

        pixf->ssd[PIXEL_16x16] = p264_pixel_ssd_16x16_mmxext;
        pixf->ssd[PIXEL_16x8]  = p264_pixel_ssd_16x8_mmxext;
        pixf->ssd[PIXEL_8x16]  = p264_pixel_ssd_8x16_mmxext;
        pixf->ssd[PIXEL_8x8]   = p264_pixel_ssd_8x8_mmxext;
        pixf->ssd[PIXEL_8x4]   = p264_pixel_ssd_8x4_mmxext;
        pixf->ssd[PIXEL_4x8]   = p264_pixel_ssd_4x8_mmxext;
        pixf->ssd[PIXEL_4x4]   = p264_pixel_ssd_4x4_mmxext;
  
        pixf->satd[PIXEL_16x16]= p264_pixel_satd_16x16_mmxext;
        pixf->satd[PIXEL_16x8] = p264_pixel_satd_16x8_mmxext;
        pixf->satd[PIXEL_8x16] = p264_pixel_satd_8x16_mmxext;
        pixf->satd[PIXEL_8x8]  = p264_pixel_satd_8x8_mmxext;
        pixf->satd[PIXEL_8x4]  = p264_pixel_satd_8x4_mmxext;
        pixf->satd[PIXEL_4x8]  = p264_pixel_satd_4x8_mmxext;
        pixf->satd[PIXEL_4x4]  = p264_pixel_satd_4x4_mmxext;
    }
#endif

#ifdef HAVE_SSE2
    // disable on AMD processors since it is slower
    if( (cpu&P264_CPU_SSE2) && !(cpu&P264_CPU_3DNOW) )
    {
        pixf->sad[PIXEL_16x16] = p264_pixel_sad_16x16_sse2;
        pixf->sad[PIXEL_16x8 ] = p264_pixel_sad_16x8_sse2;

        pixf->satd[PIXEL_16x16]= p264_pixel_satd_16x16_sse2;
        pixf->satd[PIXEL_16x8] = p264_pixel_satd_16x8_sse2;
        pixf->satd[PIXEL_8x16] = p264_pixel_satd_8x16_sse2;
        pixf->satd[PIXEL_8x8]  = p264_pixel_satd_8x8_sse2;
        pixf->satd[PIXEL_8x4]  = p264_pixel_satd_8x4_sse2;
    }
    // these are faster on both Intel and AMD
    if( cpu&P264_CPU_SSE2 )
    {
        pixf->ssd[PIXEL_16x16] = p264_pixel_ssd_16x16_sse2;
        pixf->ssd[PIXEL_16x8]  = p264_pixel_ssd_16x8_sse2;
    }
#endif

#ifdef ARCH_PPC
    if( cpu&P264_CPU_ALTIVEC )
    {
        p264_pixel_altivec_init( pixf );
    }
#endif
#ifdef ARCH_UltraSparc
      pixf->sad[PIXEL_8x8]   = p264_pixel_sad_8x8_vis;
      pixf->sad[PIXEL_8x16]  = p264_pixel_sad_8x16_vis;
      pixf->sad[PIXEL_16x8]  = p264_pixel_sad_16x8_vis;
      pixf->sad[PIXEL_16x16] = p264_pixel_sad_16x16_vis;
#endif
}
