 ...
 * p264_dct_init:
 ****************************************************************************/
void p264_dct_init( int cpu, p264_dct_function_t *dctf )
{
    ...
    {
        dctf->sub4x4_dct    = p264_sub4x4_dct_mmxext;
        dctf->sub8x8_dct    = p264_sub8x8_dct_mmxext;
        dctf->sub16x16_dct  = p264_sub16x16_dct_mmxext;

        dctf->add4x4_idct   = p264_add4x4_idct_mmxext;
        dctf->add8x8_idct   = p264_add8x8_idct_mmxext;
        dctf->add16x16_idct = p264_add16x16_idct_mmxext;

        dctf->dct4x4dc  = p264_dct4x4dc_mmxext;
        dctf->idct4x4dc = p264_idct4x4dc_mmxext;

#ifndef ARCH_X86_64
        dctf->sub8x8_dct8   = p264_sub8x8_dct8_mmxext;
        dctf->sub16x16_dct8 = p264_sub16x16_dct8_mmxext;

        dctf->add8x8_idct8  = p264_add8x8_idct8_mmxext;
        dctf->add16x16_idct8= p264_add16x16_idct8_mmxext;
#endif
    }
#endif
    ...
    {
        dctf->sub8x8_dct8   = p264_sub8x8_dct8_sse2;
        dctf->sub16x16_dct8 = p264_sub16x16_dct8_sse2;

        dctf->add8x8_idct8  = p264_add8x8_idct8_sse2;
        dctf->add16x16_idct8= p264_add16x16_idct8_sse2;
    }
#endif
    ...
    {
        dctf->sub4x4_dct    = p264_sub4x4_dct_altivec;
        dctf->sub8x8_dct    = p264_sub8x8_dct_altivec;
        dctf->sub16x16_dct  = p264_sub16x16_dct_altivec;
    }
#endif
}
